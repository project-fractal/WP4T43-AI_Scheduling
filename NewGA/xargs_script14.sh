...
cd JSON/Inputs/Inputs14
ls -d "$PWD"/* > inputs_14.txt
mv inputs_14.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_14.txt|xargs -n 1 -P 64 -t ./range
