...
cd JSON/Inputs/Inputs11
ls -d "$PWD"/* > inputs_11.txt
mv inputs_11.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_11.txt|xargs -n 1 -P 64 -t ./range
