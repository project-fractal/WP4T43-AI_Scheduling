...
cd JSON/Inputs/Inputs08
ls -d "$PWD"/* > inputs_8.txt
mv inputs_8.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_8.txt|xargs -n 1 -P 64 -t ./range
