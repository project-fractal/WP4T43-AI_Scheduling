...
cd JSON/Inputs/Inputs19
ls -d "$PWD"/* > inputs_19.txt
mv inputs_19.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_19.txt|xargs -n 1 -P 64 -t ./range
