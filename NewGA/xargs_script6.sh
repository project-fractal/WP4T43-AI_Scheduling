...
cd JSON/Inputs/Inputs06
ls -d "$PWD"/* > inputs_6.txt
mv inputs_6.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_6.txt|xargs -n 1 -P 64 -t ./range
