...
const double Graphk::DISCONNECT = (numeric_limits<double>::max)();


Graphk::Graphk( const string& file_name )
{
	_import_from_file(file_name);
}

Graphk::Graphk( const Graphk& graph )
{
...
///////////////////////////////////////////////////////////////////////////////
void Graphk::_import_from_file( const string& input_file_name )
{
...
void Graphk::set_number_vertices( const int& nVertices )
{
	m_nVertexNum = nVertices;
}

void Graphk::add_link( const int& s, const int& d, const double& weight )
{
	///3.2.1 construct the vertices
...
BaseVertex* Graphk::get_vertex( int node_id )
{
...
int Graphk::get_edge_code( const BaseVertex* start_vertex_pt, const BaseVertex* end_vertex_pt ) const
{
...
set<BaseVertex*>* Graphk::get_vertex_set_pt( BaseVertex* vertex_, map<BaseVertex*, set<BaseVertex*>*>& vertex_container_index )
{
...
double Graphk::get_edge_weight( const BaseVertex* source, const BaseVertex* sink )
{
...
void Graphk::get_adjacent_vertices( BaseVertex* vertex, set<BaseVertex*>& vertex_set )
{
...
void Graphk::get_precedent_vertices( BaseVertex* vertex, set<BaseVertex*>& vertex_set )
{
...
double Graphk::get_original_edge_weight( const BaseVertex* source, const BaseVertex* sink )
{
