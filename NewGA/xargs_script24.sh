...
cd JSON/Inputs/Inputs24
ls -d "$PWD"/* > inputs_24.txt
mv inputs_24.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_24.txt|xargs -n 1 -P 64 -t ./range
