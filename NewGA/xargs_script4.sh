...
cd JSON/Inputs/Inputs04
ls -d "$PWD"/* > inputs_4.txt
mv inputs_4.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_4.txt|xargs -n 1 -P 64 -t ./range
