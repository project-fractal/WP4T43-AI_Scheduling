...
cd JSON/Inputs/Inputs05
ls -d "$PWD"/* > inputs_5.txt
mv inputs_5.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_5.txt|xargs -n 1 -P 64 -t ./range
