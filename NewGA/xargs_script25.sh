...
cd JSON/Inputs/Inputs25
ls -d "$PWD"/* > inputs_25.txt
mv inputs_25.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_25.txt|xargs -n 1 -P 64 -t ./range
