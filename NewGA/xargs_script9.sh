...
cd JSON/Inputs/Inputs09
ls -d "$PWD"/* > inputs_9.txt
mv inputs_9.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_9.txt|xargs -n 1 -P 64 -t ./range
