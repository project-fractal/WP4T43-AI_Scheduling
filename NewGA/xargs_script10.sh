...
cd JSON/Inputs/Inputs10
ls -d "$PWD"/* > inputs_10.txt
mv inputs_10.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_10.txt|xargs -n 1 -P 64 -t ./range
