...
cd JSON/Inputs/Inputs07
ls -d "$PWD"/* > inputs_7.txt
mv inputs_7.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_7.txt|xargs -n 1 -P 64 -t ./range
