...
cd JSON/Inputs/Inputs20
ls -d "$PWD"/* > inputs_20.txt
mv inputs_20.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_20.txt|xargs -n 1 -P 64 -t ./range
