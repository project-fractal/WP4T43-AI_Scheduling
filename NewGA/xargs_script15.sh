...
cd JSON/Inputs/Inputs15
ls -d "$PWD"/* > inputs_15.txt
mv inputs_15.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_15.txt|xargs -n 1 -P 64 -t ./range
