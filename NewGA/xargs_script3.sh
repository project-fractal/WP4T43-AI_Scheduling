...
cd JSON/Inputs/Inputs03
ls -d "$PWD"/* > inputs_3.txt
mv inputs_3.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_3.txt|xargs -n 1 -P 64 -t ./range
