...
cd JSON/Inputs/Inputs12
ls -d "$PWD"/* > inputs_12.txt
mv inputs_12.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_12.txt|xargs -n 1 -P 64 -t ./range
