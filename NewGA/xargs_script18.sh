...
cd JSON/Inputs/Inputs18
ls -d "$PWD"/* > inputs_18.txt
mv inputs_18.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_18.txt|xargs -n 1 -P 64 -t ./range
