...
cd JSON/Inputs/Inputs16
ls -d "$PWD"/* > inputs_16.txt
mv inputs_16.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_16.txt|xargs -n 1 -P 64 -t ./range
