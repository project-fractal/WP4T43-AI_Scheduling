...
cd JSON/Inputs/Inputs13
ls -d "$PWD"/* > inputs_13.txt
mv inputs_13.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_13.txt|xargs -n 1 -P 64 -t ./range
