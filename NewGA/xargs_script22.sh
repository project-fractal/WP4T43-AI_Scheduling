...
cd JSON/Inputs/Inputs22
ls -d "$PWD"/* > inputs_22.txt
mv inputs_22.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_22.txt|xargs -n 1 -P 64 -t ./range
