...
cd JSON/Inputs/Inputs21
ls -d "$PWD"/* > inputs_21.txt
mv inputs_21.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_21.txt|xargs -n 1 -P 64 -t ./range
