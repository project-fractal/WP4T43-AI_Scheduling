...
cd JSON/Inputs/Inputs17
ls -d "$PWD"/* > inputs_17.txt
mv inputs_17.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_17.txt|xargs -n 1 -P 64 -t ./range
