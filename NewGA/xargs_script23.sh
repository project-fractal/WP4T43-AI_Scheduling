...
cd JSON/Inputs/Inputs23
ls -d "$PWD"/* > inputs_23.txt
mv inputs_23.txt /work/ws-tmp/cl603105-new_workspace/SNAP_and_Gen/NewGA/JSON/
...
cat JSON/inputs_23.txt|xargs -n 1 -P 64 -t ./range
